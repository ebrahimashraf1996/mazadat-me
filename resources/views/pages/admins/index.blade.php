        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                  <a href="{{route('mangers.create')}}"class="btn btn-success" style="line-height:2;font-size:14px;font-weight:bolder"> أضافة مشرف</a>
                            ...
                            <tr>
                              ...
                              <td>
                                <button class="btn btn-brand dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                        ...
                                        <a class="dropdown-item" href="{{route('permissions.show', $user->id)}}"><i class="fa fa-edit"></i>صلاحيات</a>
                    										<a class="dropdown-item" href="{{route('mangers.edit', $user->id)}}"><i class="fa fa-edit"></i> تعديل</a>
                    										<a class="dropdown-item" data-toggle="modal" href="#myModal-{{$user->id}}"><i class="fa fa-trash"></i> مسح</a>
                    									</div>
                    									<div class="modal fade" id="myModal-{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    										<div class="modal-dialog">
                    										<div class="modal-content">
                    										<div class="modal-header">
                    											<h5 class="modal-title" id="exampleModalLabel">مسح المشرف</h5>
                    											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    											</button>
                    										</div>
                    										<div class="modal-body">
                    										<form role="form"  class="form_delete" action="{{route('mangers.destroy', $user->id)}}" method="POST">
