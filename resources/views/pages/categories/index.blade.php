            ...
            <div class="card gutter-b">
              <div class="card-header flex-wrap border-0 pt-2 pb-0">
                  <div class="card-title">
                    ...
                    <a class="btn btn-danger" href="{{route('categories.soft.delete')}}"> المحذوف مؤقتا</a>
                    <h3 class="card-label" style="float:left"> الأقسام </h3>
                  </div>
              </div>
                <div class="card-body">
                    <!--begin: Search Form-->
                              ...
                              <td>
                                <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                    									...
                    									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    										<a class="btn btn-success" href="{{route('categories.edit', $category->id)}}"><i class="fa fa-edit"></i> تعديل</a>
                    										<a class="btn btn-danger" data-toggle="modal" href="#myModal-{{$category->id}}"><i class="fa fa-trash"></i> مسح</a>
                    									</div>
