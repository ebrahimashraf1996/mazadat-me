            ...
            <div class="card gutter-b">
                <div class="card-header flex-wrap border-0 pt-2 pb-0">
                    <div class="card-title">
                      ...
                      <a class="btn btn-primary" href="{{route('providers.index')}}"> عرض الموردين</a>
                              ...
                              <td>
                                <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                    									...
                    									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    										<a class="btn btn-success" href="{{route('providers.untrash', $provider->id)}}"><i class="fa fa-edit" style="left:0;position:relative"></i> الغاء الحذف</a>
                    										<a class="btn btn-danger" data-toggle="modal" href="#myModal-{{$provider->id}}"><i class="fa fa-trash"></i> حذف نهائي</a>
                    									</div>
                    									<div class="modal fade" id="myModal-{{$provider->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    										...
                    										<form role="form" action="{{route('providers.force.delete', $provider->id)}}" method="POST">
