      ...
      <a href="{{route('deliveries.index')}}"class="btn btn-success" style="border-radius:0;font-size:20px"> المناديب</a>
        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">أضافة مندوب</h3>
            </div>
            <form class="form" action="{{route('deliveries.store')}}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            <div class="checkbox-list">
                                <label class="checkbox">
                                  <input type="checkbox" name="area_id[]" value="{{$area->id}}">  <span></span> {{$area->name}}
                                </label>
                            </div>
                        </div>
                         @endforeach
